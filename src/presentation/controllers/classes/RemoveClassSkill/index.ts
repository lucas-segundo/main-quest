...
export class RemoveClassSkillController implements Controller {
  constructor(
    private readonly removeClassSkillRepo: RemoveClassSkillRepository,
  ...
  async handle(
    ...
    try {
      const classWithSkill = await this.removeClassSkillRepo.remove(
        classID,
        skillIDs,
      )
