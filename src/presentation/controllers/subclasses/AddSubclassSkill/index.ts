...
export class AddSubclassSkillController implements Controller {
  constructor(
    private readonly addSubclassSkillRepo: AddSubclassSkillRepository,
  ...
  async handle(
    ...
    try {
      const classWithSkill = await this.addSubclassSkillRepo.add(
        classID,
        skillIDs,
      )
