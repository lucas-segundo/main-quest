...
import { mockAddSubclassSpellRepository } from 'entities/Subclass/repositories/AddSubclassSpell/mock'
...
const makeSUT = () => {
  const addSubclassSpellRepo = mockAddSubclassSpellRepository()
